...
import {ModalEditInterface, Task } from '@/Models/Types';
...
export default function EditModal({modalIsOpen,closeModal,editTask}:ModalEditInterface) {
    const [modalForm,SetModalForm]= useState<Task>(editTask)
    ...
    <div >
        <Modal
        isOpen={modalIsOpen}
        onRequestClose={(e)=>closeModal(undefined)}
        style={customStyles}>
        <form
            ...
            <div className='flex mb-3'>
                <p className='pr-2' >Edit Description:</p>
                <textarea
